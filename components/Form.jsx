  ...
  return (
    <section className="w-full max-w-full flex-start flex-col">
      <h1 className="head_text text-left">
        <span className="gptgreen">{type} Post</span>
      </h1>
      <p className="desc text-left max-w-md">
        {type} and share amazing prompts with the AI world !
      </p>
      <form
      ...
      >
        ...
        <div className="flex-end mx-3 mb-5 gap-4">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="px-5 py-1.5 text-sm gptgreen_bg rounded-full text-white"
          >
